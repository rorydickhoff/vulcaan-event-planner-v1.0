...
const DEFAULT_TURF_ITEMS = [
  ...
  {
    id: "speciaal",
    naam: "Vulcaan Speciaalbier",
    prijs: 5.5,
    btw: 21,
    categorie: "Bier",
  },
  { id: "wijn", naam: "Huiswijn", prijs: 4.5, btw: 21, categorie: "Wijn" },
  { id: "cava", naam: "Cava", prijs: 5.5, btw: 21, categorie: "Wijn" },
  {
    id: "gedestilleerd",
    naam: "Gedestilleerd",
    prijs: 6.0,
  ...
  { id: "fris", naam: "Frisdrank", prijs: 3.5, btw: 9, categorie: "Fris" },
  { id: "koffie", naam: "Koffie/Thee", prijs: 3.2, btw: 9, categorie: "Warm" },
  {
    id: "bitterbal",
    naam: "Bitterballen (10st)",
    prijs: 11.0,
    btw: 9,
    categorie: "Snacks",
  },
  ...
  const createNewEvent = () => {
    const newEvent = {
      ...
      briefing: {
        ...
        telefoonVulcaan: "",
        emailVulcaan: "",
        omschrijvingProgramma: "",
        omschrijvingInrichting: "",
        omschrijvingVerzorging: "",
        bijlagen: "",
        todos: [],
        draaiboek: [],
        rooster: [],
      ...
      offerte: [
        ...
        {
          id: "o3",
          dienst: "Personen tafelgarnituur",
          aantal: 1,
          uren: 1,
          tarief: 2.0,
          btw: 9,
        ...
        {
          id: "o4",
          dienst: "Personen Bittergarnituur",
          aantal: 1,
          uren: 1,
          tarief: 1.0,
          btw: 9,
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800 pb-12 relative">
      ...
      <header className="bg-red-700 text-white p-4 shadow-md flex items-center justify-between print-hidden">
        <div className="flex items-center gap-3">
          ...
          />
          <h1 className="text-2xl font-bold tracking-wider uppercase hidden sm:block">
            Vulcaan Event Manager
          </h1>
        </div>
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            ...
            <button
              ...
              className="text-xs flex items-center gap-1 hover:text-red-200 transition"
            >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 print-hidden">
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full border-t-4 border-red-600">
            ...
            <p className="text-gray-600 mb-6">
              Je staat op het punt het evenement{" "}
              <strong>"{eventToDelete.naam}"</strong> te verwijderen. De
              gegevens gaan permanent verloren en dit kan niet ongedaan worden
              gemaakt.
            </p>
...
function Dashboard({ events, onOpen, onCreate, onUpdateEvent, onDelete }) {
  ...
  const eventsToekomst = events
    .filter((e) => e.datum > today || !e.datum)
    .sort((a, b) => (a.datum || "9999").localeCompare(b.datum || "9999"));
  const eventsVerleden = events
    .filter((e) => e.datum && e.datum < today)
  ...
  const renderTable = (title, dataList, emptyMsg, headerColor) => (
    <div className="mb-8">
      <h3
        className={`text-xl font-bold mb-3 px-3 py-2 rounded-t-lg ${headerColor} flex items-center gap-2 shadow-sm`}
      >
          ...
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="bg-gray-50 border-b">
                ...
                {title === "Verleden" && (
                  <th className="p-4 font-semibold text-gray-600">Afronding</th>
                )}
              ...
              {dataList.map((ev) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <button
                      onClick={() => onOpen(ev)}
                      className="font-bold text-red-700 hover:text-red-900 hover:underline text-left text-lg"
                    >
                      {ev.naam}
                    </button>
                  </td>
                  ...
                  <td className="p-4">
                    <select
                      ...
                      onChange={(e) =>
                        onUpdateEvent(ev.id, { status: e.target.value })
                      }
                    ...
                    <td className="p-4 text-sm whitespace-nowrap">
                      <label className="flex items-center gap-2 mb-2 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            onUpdateEvent(ev.id, {
                              turflijstGecontroleerd: e.target.checked,
                            })
                          }
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            onUpdateEvent(ev.id, {
                              factuurVerzonden: e.target.checked,
                            })
                          }
                          className="w-4 h-4 rounded text-red-600 focus:ring-red-600 cursor-pointer"
                        />
                      ...
                      {customActionId === ev.id ? (
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            onKeyDown={(e) =>
                              e.key === "Enter" && saveCustomAction(ev.id)
                            }
                          ...
                          />
                          <button
                            onClick={() => saveCustomAction(ev.id)}
                        ...
                        <select
                          value={ev.actie || ""}
                          onChange={(e) =>
                            handleActieChange(ev, e.target.value)
                          }
                        ...
                        >
                          ...
                          {ev.actie &&
                            !PREDEFINED_ACTIONS.includes(ev.actie) && (
                              <option value={ev.actie}>{ev.actie}</option>
                            )}
                          <option value="CUSTOM" className="italic font-bold">
                            + Eigen actie invoeren
                          </option>
                        </select>
                      )}
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      ...
      {renderTable(
        "Vandaag",
        eventsVandaag,
        "Er zijn vandaag geen evenementen gepland.",
        "bg-red-700 text-white"
      )}
      {renderTable(
        "Toekomst",
        eventsToekomst,
        "Geen toekomstige evenementen gevonden.",
        "bg-gray-200 text-gray-800"
      )}
      {renderTable(
        "Verleden",
        eventsVerleden,
        "Geen afgeronde evenementen in het systeem.",
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row min-h-[80vh] print-wrapper">
      ...
      <div className="w-full md:w-64 bg-gray-50 border-r flex flex-col print-hidden">
        ...
        <nav className="flex-1 p-2 space-y-1">
          <TabButton
            ...
            label="1. Briefing & Info"
            active={activeTab === TABS.BRIEFING}
            onClick={() => setActiveTab(TABS.BRIEFING)}
          />
          <TabButton
            icon={<Receipt size={18} />}
            label="2. Offerte"
            active={activeTab === TABS.OFFERTE}
            onClick={() => setActiveTab(TABS.OFFERTE)}
          />
          <TabButton
            icon={<Beer size={18} />}
            label="3. Turflijst (Bar)"
            active={activeTab === TABS.TURFLIJST}
            onClick={() => setActiveTab(TABS.TURFLIJST)}
          />
          <TabButton
            icon={<MessageSquare size={18} />}
            label="4. Debriefing"
            active={activeTab === TABS.DEBRIEFING}
            onClick={() => setActiveTab(TABS.DEBRIEFING)}
          />
          <TabButton
            icon={<CheckCircle size={18} />}
            label="5. Facturatie"
            active={activeTab === TABS.FACTUUR}
            onClick={() => setActiveTab(TABS.FACTUUR)}
          />
        </nav>
        <div className="p-4 border-t">
          <button
            type="button"
            onClick={handleSave}
            className="w-full bg-red-700 hover:bg-red-800 text-white py-2 rounded flex items-center justify-center gap-2 transition font-bold shadow"
          >
      ...
      <div className="flex-1 p-6 overflow-y-auto bg-gray-50/50 print-wrapper relative">
        {activeTab === TABS.BRIEFING && (
          <TabBriefing data={formData} updateField={updateField} />
        )}
        {activeTab === TABS.OFFERTE && (
          <TabOfferte data={formData} updateField={updateField} />
        )}
        {activeTab === TABS.TURFLIJST && (
          <TabTurflijst data={formData} updateField={updateField} />
        )}
        {activeTab === TABS.DEBRIEFING && (
          <TabDebriefing data={formData} updateField={updateField} />
        )}
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-3 px-4 py-3 rounded-md text-left transition ${
        active
          ? "bg-red-100 text-red-900 font-bold border-l-4 border-red-700"
          : "text-gray-600 hover:bg-gray-200 border-l-4 border-transparent"
      }`}
    >
      ...
      <button
        ...
        onClick={() => {
          try {
            ...
            console.error("Print blocked in iframe:", e);
          }
        }}
...
function TabBriefing({ data, updateField }) {
  ...
  const addTodoItem = () => {
    updateField("briefing.todos", [
      ...b.todos,
      { id: Date.now().toString(), taak: "", voldaan: false },
    ]);
  };
  ...
  const updateTodoItem = (id, field, value) => {
    updateField(
      "briefing.todos",
      b.todos.map((t) => (t.id === id ? { ...t, [field]: value } : t))
    );
  };
  ...
  const removeTodoItem = (id) => {
    updateField(
      "briefing.todos",
      b.todos.filter((t) => t.id !== id)
    );
  };

  const addDraaiboekItem = () => {
    updateField("briefing.draaiboek", [
      ...b.draaiboek,
      { tijd: "", omschrijving: "", wie: "" },
    ]);
  };
  ...
  const removeDraaiboekItem = (idx) => {
    updateField(
      "briefing.draaiboek",
      b.draaiboek.filter((_, i) => i !== idx)
    );
  };

  const addRoosterItem = () => {
    updateField("briefing.rooster", [
      ...b.rooster,
      { naam: "", rol: "", starttijd: "", eindtijd: "", werkelijk: "" },
    ]);
  };
    ...
    <div className="space-y-8 animate-in fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-blue-50 border border-blue-200 p-4 rounded-lg shadow-sm print-hidden gap-4">
        <div>
          <h4 className="font-bold text-blue-800 flex items-center gap-2">
            <Calendar size={18} /> Exporteer naar Google Calendar
          </h4>
          <p className="text-sm text-blue-600 mt-1">
            Zet dit evenement direct in je agenda.
          </p>
          {!isCalendarReady && (
            <p className="text-xs text-red-500 mt-1 font-bold">
              Vul eerst een datum, starttijd en eindtijd in.
            </p>
          )}
        </div>
        <a
      ...
      <div className="hidden print-only mb-6 border-b-2 border-black pb-4">
        ...
        <p className="text-lg font-medium">
          Datum: {data.datum || "Nog niet ingevuld"}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 print-break-inside-avoid">
        <div className="bg-white p-4 rounded-lg print-border shadow-sm space-y-4">
          <h3 className="font-bold text-lg flex items-center gap-2 border-b pb-1 text-red-800">
            <Calendar size={18} /> Algemeen
          </h3>
          <Input
          ...
          <div className="grid grid-cols-2 gap-2">
            <Input
              label="Doelgroep"
              value={b.doelgroep}
              onChange={(v) => updateField("briefing.doelgroep", v)}
            />
            <Input
              label="Aantal personen (PAX)"
              type="number"
              value={b.pax}
              onChange={(v) => updateField("briefing.pax", v)}
            />
          </div>
          <Input
            label="Dieetwensen / Allergieën"
            value={b.allergieen}
            onChange={(v) => updateField("briefing.allergieen", v)}
            placeholder="Bijv. 2x Glutenvrij, 1x Vega..."
          />
        </div>
        <div className="bg-white p-4 rounded-lg print-border shadow-sm space-y-4">
          <h3 className="font-bold text-lg flex items-center gap-2 border-b pb-1 text-red-800">
            <Clock size={18} /> Tijden
          </h3>
          <div className="grid grid-cols-3 gap-2">
            <TimeInput
              label="Get in"
              value={b.tijden.getIn}
              onChange={(v) => updateField("briefing.tijden.getIn", v)}
            />
            <TimeInput
              label="Start event"
              value={b.tijden.start}
              onChange={(v) => updateField("briefing.tijden.start", v)}
            />
            <TimeInput
              label="Einde event"
              value={b.tijden.eind}
              onChange={(v) => updateField("briefing.tijden.eind", v)}
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg print-border shadow-sm space-y-4 print-break-inside-avoid">
        <div className="flex justify-between items-center border-b pb-2">
          <h3 className="font-bold text-lg text-red-800 flex items-center gap-2">
            <CheckSquare size={18} /> To-Do / Checklist (Voorbereiding)
          </h3>
          <button
            type="button"
            onClick={addTodoItem}
            className="text-sm bg-red-100 hover:bg-red-200 text-red-800 px-3 py-1 rounded flex items-center gap-1 transition print-hidden font-semibold"
          >
        ...
        <div className="space-y-2">
          {b.todos.map((todo) => (
            <div key={todo.id} className="flex gap-2 items-center">
              <input
                ...
                onChange={(e) =>
                  updateTodoItem(todo.id, "voldaan", e.target.checked)
                }
              ...
              <input
                ...
                className={`border rounded p-2 text-sm flex-1 outline-none ${
                  todo.voldaan
                ...
                value={todo.taak}
                onChange={(e) =>
                  updateTodoItem(todo.id, "taak", e.target.value)
                }
              />
              <button
                type="button"
                onClick={() => removeTodoItem(todo.id)}
                className="text-red-500 p-2 hover:bg-red-50 rounded print-hidden"
              >
                <Trash2 size={18} />
              </button>
            </div>
          ...
          {b.todos.length === 0 && (
            <p className="text-sm text-gray-500 italic">
              Geen to-do's ingevoerd. Voeg taken toe om de voorbereiding te
              tracken.
            </p>
          )}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-4 rounded-lg print-border shadow-sm print-break-inside-avoid">
        <div className="space-y-4">
          <h3 className="font-bold text-lg border-b pb-1 text-red-800">
            Contact & Facturatie Klant
          </h3>
          <Input
            label="Naam Contactpersoon"
            value={b.contactKlant}
            onChange={(v) => updateField("briefing.contactKlant", v)}
          />
          <Input
            label="Bedrijfsnaam (optioneel)"
            value={b.bedrijfsnaam}
            onChange={(v) => updateField("briefing.bedrijfsnaam", v)}
          />
          <div className="grid grid-cols-2 gap-2">
            <Input
              label="Straat en Huisnummer"
              value={b.adresKlant}
              onChange={(v) => updateField("briefing.adresKlant", v)}
            />
            <Input
              label="Postcode"
              value={b.postcodeKlant}
              onChange={(v) => updateField("briefing.postcodeKlant", v)}
            />
          </div>
          <Input
            label="Woonplaats"
            value={b.woonplaatsKlant}
            onChange={(v) => updateField("briefing.woonplaatsKlant", v)}
          />
          <Input
            label="Referentienummer / PO (optioneel)"
            value={b.referentieNummer}
            onChange={(v) => updateField("briefing.referentieNummer", v)}
          />
          <Input
            label="Telefoonnummer"
            value={b.telefoonKlant}
            onChange={(v) => updateField("briefing.telefoonKlant", v)}
          />
          <Input
            label="E-mailadres"
            value={b.emailKlant}
            onChange={(v) => updateField("briefing.emailKlant", v)}
          />
        </div>
        <div className="space-y-4">
          <h3 className="font-bold text-lg border-b pb-1 text-red-800">
          ...
          <Input
            label="Verantwoordelijke Vulcaan"
            value={b.contactVulcaan}
            onChange={(v) => updateField("briefing.contactVulcaan", v)}
          />
          <Input
            label="Telefoonnummer"
            value={b.telefoonVulcaan}
            onChange={(v) => updateField("briefing.telefoonVulcaan", v)}
          />
          <Input
            label="E-mailadres"
            value={b.emailVulcaan}
            onChange={(v) => updateField("briefing.emailVulcaan", v)}
          />
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg print-border shadow-sm space-y-4 print-break-inside-avoid">
        ...
        <Textarea
          label="Programma"
          value={b.omschrijvingProgramma}
          onChange={(v) => updateField("briefing.omschrijvingProgramma", v)}
        />
        <Textarea
          label="Inrichting (zaal, tent, etc.)"
          value={b.omschrijvingInrichting}
          onChange={(v) => updateField("briefing.omschrijvingInrichting", v)}
        />
        <Textarea
          label="Verzorging (eten, drinken, extra's)"
          value={b.omschrijvingVerzorging}
          onChange={(v) => updateField("briefing.omschrijvingVerzorging", v)}
        />
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 print-hidden">
          <h4 className="font-bold text-gray-700 flex items-center gap-2 mb-2">
            <Paperclip size={16} /> Bijlagen / Upload Notities
          </h4>
          <p className="text-xs text-gray-500 mb-2 print-hidden">
            Plaats hier links naar cloudmappen of aantekeningen over externe
            facturen.
          </p>
          <Textarea
            label=""
            value={b.bijlagen}
            onChange={(v) => updateField("briefing.bijlagen", v)}
          />
        </div>
      </div>
          ...
          <div className="space-y-2 min-w-[600px]">
            {b.draaiboek.map((item, idx) => (
              <div key={idx} className="flex gap-2 items-center">
                <TimeSelect
                  value={item.tijd}
                  onChange={(v) => updateDraaiboek(idx, "tijd", v)}
                  className="w-24"
                />
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    updateDraaiboek(idx, "omschrijving", e.target.value)
                  }
                />
                <input
                  type="text"
                  ...
                  value={item.wie}
                  onChange={(e) => updateDraaiboek(idx, "wie", e.target.value)}
                />
                <button
                  type="button"
                  onClick={() => removeDraaiboekItem(idx)}
                  className="text-red-500 p-2 hover:bg-red-50 rounded print-hidden"
                >
                  <Trash2 size={18} />
                </button>
            ...
            {b.draaiboek.length === 0 && (
              <p className="text-sm text-gray-500 italic">
                Geen draaiboek items ingevoerd.
              </p>
            )}
          </div>
        </div>
          ...
          <div className="space-y-2 min-w-[700px]">
            {b.rooster.length > 0 && (
              <div className="flex gap-2 px-1 pb-1">
                ...
                <span className="w-32 text-xs font-bold text-gray-500 uppercase">
                  Rol
                </span>
                <span className="w-24 text-xs font-bold text-gray-500 uppercase text-center">
                  Start
                </span>
                <span className="w-24 text-xs font-bold text-gray-500 uppercase text-center">
                  Eind
                ...
                <span
                  className="w-24 text-xs font-bold text-gray-500 uppercase text-center print-hidden"
                  title="Daadwerkelijk gewerkte uren invullen achteraf"
                >
                  Werkelijk (U)
                </span>
            ...
            {b.rooster.map((item, idx) => (
              <div key={idx} className="flex gap-2 items-center">
                <input
                  ...
                  className="border rounded p-2 text-sm flex-1"
                  value={item.naam}
                  onChange={(e) => updateRooster(idx, "naam", e.target.value)}
                />
                <input
                  type="text"
                  placeholder="Rol (bijv. Bar)"
                  className="border rounded p-2 text-sm w-32"
                  value={item.rol}
                  onChange={(e) => updateRooster(idx, "rol", e.target.value)}
                />
                <TimeSelect
                  value={item.starttijd}
                  onChange={(v) => updateRooster(idx, "starttijd", v)}
                  className="w-24"
                />
                <TimeSelect
                  value={item.eindtijd}
                  onChange={(v) => updateRooster(idx, "eindtijd", v)}
                  className="w-24"
                />
                <input
                  type="number"
                  step="0.25"
                  placeholder="Uren"
                  className="border rounded p-2 text-sm w-24 text-center bg-gray-50 focus:bg-white print-hidden"
                  value={item.werkelijk || ""}
                  onChange={(e) =>
                    updateRooster(idx, "werkelijk", e.target.value)
                  }
                  title="Vul hier na afloop de echt gemaakte uren in"
                />
                <button
                  type="button"
                  onClick={() => removeRoosterItem(idx)}
                  className="text-red-500 p-2 hover:bg-red-50 rounded print-hidden w-10"
                >
                  <Trash2 size={18} />
                </button>
              </div>
            ...
            {b.rooster.length === 0 && (
              <p className="text-sm text-gray-500 italic">
                Geen personeelsrooster ingevoerd.
              </p>
            )}
          </div>
        </div>
      ...
      {o && o.length > 0 && (
        <div className="hidden print:block print-break-before">
          <h3 className="text-xl font-bold border-b-2 border-red-700 pb-1 mb-4">
            Interne info: Te verzorgen diensten & raming
          </h3>
          <table className="w-full text-sm border-collapse">
            <thead className="bg-gray-100">
              <tr>
                <th className="p-2 border-b border-gray-300 w-16 text-center">
                  Aantal
                </th>
          ...
          <p className="text-xs text-gray-500 mt-2 italic">
            Dit overzicht is voor intern gebruik om te weten wat er is
            afgesproken in de raming.
          </p>
        </div>
      )}
    </div>
...
function TabOfferte({ data, updateField }) {
  ...
  const removeRow = (id) => {
    updateField(
      "offerte",
      o.filter((row) => row.id !== id)
    );
  };

  const calcTotaal = (row) =>
    (Number(row.aantal) || 1) *
    (Number(row.uren) || 1) *
    (Number(row.tarief) || 0);
  ...
  return (
    <div className="space-y-6 animate-in fade-in relative">
      ...
      <p className="text-sm text-gray-600 mb-4 print-hidden bg-gray-100 p-3 rounded border border-gray-200">
        <strong>Instructie:</strong> Zet het vinkje bij{" "}
        <strong>"In Factuur?"</strong> <em>uit</em> bij consumpties en hapjes
        die later via de turflijst worden geturfd. Alle bedragen invoeren{" "}
      ...
      <div className="bg-white rounded-lg border shadow-sm overflow-hidden print-hidden">
          ...
          <table className="w-full text-left text-sm min-w-[800px]">
            <thead className="bg-gray-100 border-b">
              <tr>
                ...
                <th
                  className="p-3 w-24 text-center font-semibold"
                  title="Zet dit vinkje UIT voor consumpties die via de turflijst lopen"
                >
                  In factuur?
                </th>
                ...
                <tr key={row.id} className="border-b hover:bg-gray-50">
                  <td className="p-2">
                    <input
                      ...
                      value={row.aantal}
                      onChange={(e) =>
                        updateRow(row.id, "aantal", e.target.value)
                      }
                    />
                  </td>
                  <td className="p-2">
                    <input
                      type="text"
                      className="w-full border-gray-300 rounded p-1 text-sm font-medium text-gray-800"
                      value={row.dienst}
                      onChange={(e) =>
                        updateRow(row.id, "dienst", e.target.value)
                      }
                      placeholder="Zaalhuur, bitterballen, etc."
                    />
                  </td>
                  <td className="p-2">
                    <input
                      ...
                      value={row.uren}
                      onChange={(e) =>
                        updateRow(row.id, "uren", e.target.value)
                      }
                    />
                  </td>
                  <td className="p-2">
                    <div className="flex items-center justify-between border border-gray-300 rounded p-1 bg-white focus-within:border-red-700 focus-within:ring-1 focus-within:ring-red-700 overflow-hidden">
                      ...
                      <input
                        type="number"
                        step="0.01"
                        className="w-full text-right outline-none bg-transparent text-sm font-semibold"
                        value={row.tarief}
                        onChange={(e) =>
                          updateRow(row.id, "tarief", e.target.value)
                        }
                      />
                    </div>
                  </td>
                  <td className="p-2 text-center">
                    <select
                      ...
                      value={row.btw}
                      onChange={(e) => updateRow(row.id, "btw", e.target.value)}
                    >
                  ...
                  <td className="p-2 text-center">
                    <input
                      ...
                      onChange={(e) =>
                        updateRow(row.id, "inFactuur", e.target.checked)
                      }
                    />
                  </td>
                  <td className="p-2 text-center">
        ...
        <div className="p-4 bg-gray-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b">
          <button
            type="button"
            onClick={addRow}
            className="text-red-700 font-bold flex items-center gap-1 hover:underline transition"
          >
          ...
          <div className="text-right text-sm space-y-1 w-72">
            ...
            <p className="text-xs text-gray-500 italic mt-2 text-left pt-2">
              *Schatting, dranken worden altijd gefactureerd op basis van
              nacalculatie.
            </p>
          </div>
        </div>
        ...
        <div className="p-4 bg-gray-100 flex justify-end">
          <div className="flex items-center gap-3">
            <label className="font-semibold text-gray-700 text-sm uppercase tracking-wide">
              Reeds betaald (Aanbetaling/Borg):
            </label>
            <div className="flex items-center bg-white border border-gray-300 rounded px-2 py-1 shadow-sm focus-within:border-red-600">
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("aanbetaling", parseFloat(e.target.value) || 0)
                }
              />
            </div>
          </div>
      ...
      <div className="hidden print:block bg-white p-8">
        ...
        <div className="flex justify-between items-start mb-12">
          ...
          <div className="text-right">
            <h1 className="text-3xl font-black text-red-800 uppercase tracking-widest mb-4">
              Offerte
            </h1>
            {b.bedrijfsnaam && (
        ...
        <div className="mb-10">
          ...
          <table className="w-full text-sm">
            <tbody>
              <tr>
                <td className="font-bold py-1 w-40">Evenement:</td>
                <td>{data.naam}</td>
              </tr>
              <tr>
                <td className="font-bold py-1">Datum:</td>
                <td>{data.datum}</td>
              </tr>
              <tr>
                <td className="font-bold py-1">Tijden:</td>
                <td>
                  Start: {b.tijden.start || "-"} | Einde: {b.tijden.eind || "-"}
                </td>
              </tr>
              <tr>
                <td className="font-bold py-1">Aantal personen:</td>
                <td>{b.pax || "-"} personen</td>
              </tr>
              {b.referentieNummer && (
                <tr>
                  <td className="font-bold py-1">Uw referentie:</td>
                  <td>{b.referentieNummer}</td>
                </tr>
              )}
            </tbody>
          </table>
          ...
          <table className="w-full text-sm mb-6 border-collapse">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="p-2 border-b border-gray-300 text-right w-32">
                  Tarief (incl BTW)
                </th>
                <th className="p-2 border-b border-gray-300 text-right w-32">
                  Totaal
  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-12 relative">
      ...
      <p className="text-sm text-gray-500 mb-6 print-hidden">
        Tik op de grote knoppen om een item op te tellen of af te trekken.
      </p>
      ...
      <div className="print-hidden">
        {categories.map((cat) => (
          <div key={cat} className="space-y-3 mb-6">
            <h3 className="font-bold text-xl text-red-800 bg-red-50 inline-block px-3 py-1 rounded print-border border-red-100">
              {cat}
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {allItems
                ...
                .map((item) => (
                  <div
                    key={item.id}
                    className="bg-white p-4 rounded-xl shadow print-border border-gray-200 flex flex-col items-center text-center relative"
                  >
                    ...
                    <span className="font-bold text-gray-700 mb-4 mt-6 h-10 flex items-center justify-center leading-tight text-sm md:text-base">
                      {item.naam}
                    </span>
                    <div className="flex items-center gap-4 w-full justify-between">
                      ...
                      <span className="text-3xl font-black text-red-700 w-12">
                        {t[item.id] || 0}
                      </span>
                      <button
                        type="button"
        ...
        <div className="mt-8 bg-white p-4 rounded-lg shadow print-border border-gray-200">
          <h4 className="font-bold text-gray-700 mb-2">
            Speciaal verzoek of onbekend item?
          </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-white p-4 rounded-lg shadow print-border border-gray-200">
            <h4 className="font-bold text-red-800 flex items-center gap-2 mb-2">
              <Edit size={16} /> Logboek / Notities Barpersoneel
            </h4>
            <p className="text-xs text-gray-500 mb-2">
              Plaats hier bijzonderheden over het verloop van de avond of
              opmerkingen over betalingen.
            </p>
            <textarea
          ...
          <div className="bg-white p-4 rounded-lg shadow print-border border-gray-200">
            <h4 className="font-bold text-red-800 flex items-center gap-2 mb-2">
              <Trash2 size={16} /> Breuk & Schade Registratie
            </h4>
            <p className="text-xs text-gray-500 mb-2">
              Noteer hier gebroken glazen of eventuele schade die doorbelast
              moet worden.
            </p>
            <textarea
              className="w-full border border-gray-300 rounded p-2 min-h-[100px] outline-none focus:border-red-700 text-sm"
      ...
      <div className="hidden print:block bg-white p-8">
              ...
              .map((id) => {
                ...
                return (
                  <tr key={id} className="border-b border-gray-100">
                    <td className="p-2 text-center font-black text-gray-900">
                      {t[id]}
                    </td>
                    ...
                    <td className="p-2 text-right text-gray-600">
                      € {Number(defItem.prijs).toFixed(2)}
                    </td>
                    <td className="p-2 text-right font-bold">
                      € {(t[id] * defItem.prijs).toFixed(2)}
                    </td>
                  </tr>
                );
              })}
        ...
        {(data.logboek || data.schade) && (
          <div className="grid grid-cols-2 gap-8 print-break-inside-avoid">
            {data.logboek && (
              <div>
                <h4 className="font-bold text-red-800 border-b border-gray-300 pb-1 mb-2">
                  Logboek / Notities
                </h4>
  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-12 max-w-4xl mx-auto">
      ...
      <p className="text-sm text-gray-600 mb-6 print-hidden">
        Deze vragenlijst is bedoeld voor de Partymanager (FM) om na het sluiten
        van het evenement in te vullen. Zo houden we de kwaliteit hoog en
        evalueren we elk feest netjes.
      </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow print-border border-gray-200 space-y-6 print-break-inside-avoid">
        <div className="flex flex-col">
          <label className="font-bold text-gray-800 mb-2 text-lg">
            1. Wat ging er goed vanavond?
          </label>
          <textarea
        ...
        <div className="flex flex-col border-t border-gray-100 pt-6">
          <label className="font-bold text-gray-800 mb-2 text-lg">
            3. Is de klant tevreden vertrokken?
          </label>
          <textarea
        ...
        <div className="flex flex-col border-t border-gray-100 pt-6">
          <label className="font-bold text-gray-800 mb-2 text-lg">
            4. Overige opmerkingen voor administratie/planning
          </label>
          <textarea
            className="w-full border border-gray-300 rounded p-3 min-h-[80px] outline-none focus:border-red-700 text-sm print-hidden bg-white"
            value={d.opmerkingen}
            onChange={(e) =>
              updateField("debriefing.opmerkingen", e.target.value)
            }
...
function TabFactuur({ data }) {
  ...
  const factuurOfferteItems = data.offerte.filter(
    (row) => row.inFactuur !== false
  );
  ...
  const generateUBL = () => {
    ...
    const klantNaam =
      data.briefing.bedrijfsnaam ||
      data.briefing.contactKlant ||
      "Onbekende Klant";
...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
  ...
  <cac:LegalMonetaryTotal>
    <cbc:TaxExclusiveAmount currencyID="EUR">${totaalEx.toFixed(
      2
    )}</cbc:TaxExclusiveAmount>
    <cbc:TaxInclusiveAmount currencyID="EUR">${totaalIncl.toFixed(
      2
    )}</cbc:TaxInclusiveAmount>
    <cbc:PrepaidAmount currencyID="EUR">${aanbetaling.toFixed(
      2
    )}</cbc:PrepaidAmount>
    <cbc:PayableAmount currencyID="EUR">${nogTeVoldoen.toFixed(
      2
    )}</cbc:PayableAmount>
  </cac:LegalMonetaryTotal>
</Invoice>`;
    ...
    <div className="space-y-6 animate-in fade-in max-w-4xl mx-auto pb-10">
      <div className="flex justify-between items-end border-b border-red-200 pb-2 mb-6 print-hidden">
        ...
        <div className="flex gap-2">
          <button
            onClick={generateUBL}
            className="bg-blue-600 text-white px-4 py-2 rounded text-sm flex gap-2 items-center hover:bg-blue-700 transition shadow"
          >
      ...
      <div
        className="bg-white p-8 rounded-lg shadow print-border"
      ...
      >
        <div className="flex justify-between mb-8">
          ...
          <div className="text-right">
            ...
            <p className="text-sm text-gray-600 mt-1">
              {data.briefing.adresKlant}
              <br />
              {data.briefing.postcodeKlant} {data.briefing.woonplaatsKlant}
            </p>
            <p className="text-sm text-gray-600 mt-1">
              {data.briefing.emailKlant}
            </p>

            <div className="text-sm text-gray-600 mt-4 border-t pt-2">
              <p>
                <strong>Evenement:</strong> {data.naam}
              </p>
              <p>
                <strong>Datum:</strong> {data.datum}
              </p>
              {data.briefing.referentieNummer && (
                <p>
                  <strong>Uw ref:</strong> {data.briefing.referentieNummer}
                </p>
              )}
            </div>
          </div>
        ...
        {factuurOfferteItems.length > 0 && (
          <div className="print-break-inside-avoid">
            <h4 className="font-bold border-b border-gray-300 pb-1 mb-2 mt-6 text-red-800">
              Vaste kosten (volgens offerte)
            </h4>
            <table className="w-full text-sm mb-6">
              <thead className="bg-gray-50">
                <tr>
                  <th className="p-2 text-left border-b border-gray-300 w-16 text-center">
                    Aantal
                  </th>
                  ...
                  <th className="p-2 text-right border-b border-gray-300 w-32">
                    Tarief (incl BTW)
                  </th>
                  <th className="p-2 text-right border-b border-gray-300 w-32">
                    Totaal
              ...
              <tbody>
                {turfItemsList.map((item, idx) => (
                  <tr key={idx} className="border-b border-gray-100">
                    <td className="p-2 text-center text-gray-950 font-black">
                      {item.aantal}
                    </td>
                    <td className="p-2 text-gray-800 font-semibold">
                      {item.naam}
